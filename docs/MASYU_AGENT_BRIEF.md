...
16. `Empty Cell Candidate Pruning`
17. `Cell Exit Completion`
...
- Empty cell candidate pruning for selected non-pearl cells, using bounded
  degree-0/degree-2 candidates without deterministic trial propagation.
